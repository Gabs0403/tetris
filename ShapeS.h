...
// by: Gabriel Correa
// description: S shape for game tetris derived from the base class tetromino
//-------------------------------------------------------------------------------
#include "tetris.h"
#include "Tetromino.h"
...
class ShapeS : public Tetromino{ //ShapeS will be able to use properties and methods from Tetromino class( except private)
private:
