...
// by: Gabriel Correa
// description: L shape for game tetris derived from the base class tetromino
//-------------------------------------------------------------------------------
#include "tetris.h"
#include "Tetromino.h"
...
class ShapeL : public Tetromino{ //ShapeL will be able to use properties and methods from Tetromino class( except private)
private:
...
public:
    ...
    int blocks[9] = {0,1,0,0,1,0,0,1,1};
